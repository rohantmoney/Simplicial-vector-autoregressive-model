...
(1) Run the file 'Experiment_A_Synthatic_1.m': This will enable you to compare the normalized mean squared error of SC-VAR with state-of-the-art competitors for time-varying data generation model. 
(2) Run the file 'Experiment_A_Synthatic_2.m': This will enable you to compare the normalized mean squared error of SC-VAR with S-VAR for stationary data generation model. 
