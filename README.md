...
After downloading the repository, run the file 'Experiment_B_Synthatic.m'. This will enable you to compare the normalized mean squared error of SC-VAR with state-of-the-art competitors.
